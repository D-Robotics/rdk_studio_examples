...
module.exports = {
     ...
     ******************************************************************************/
        ...
        https: {
          key: require("fs").readFileSync(require("path").resolve(require("os").homedir(), '.node-red/keys/private.key')),
          cert: require("fs").readFileSync(require("path").resolve(require("os").homedir(), '.node-red/keys/certificate.crt'))
        },
        ...
        //     return {
        //         key: require("fs").readFileSync('/home/sunrise/.node-red/keys/private.key'),
        //         cert: require("fs").readFileSync('/home/sunrise/.node-red/keys/certificate.crt')
        //     }
        //},
